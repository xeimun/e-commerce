...
select id, 120, timestamp '2026-06-06 00:00:00', timestamp '2026-06-06 00:00:00'
from products
where id = 10001
  and not exists (select 1 from stocks where product_id = 10001);

insert into stocks (product_id, quantity, created_at, updated_at)
select id, 80, timestamp '2026-06-06 00:00:00', timestamp '2026-06-06 00:00:00'
from products
where id = 10002
  and not exists (select 1 from stocks where product_id = 10002);

insert into stocks (product_id, quantity, created_at, updated_at)
select id, 60, timestamp '2026-06-06 00:00:00', timestamp '2026-06-06 00:00:00'
from products
where id = 10003
  and not exists (select 1 from stocks where product_id = 10003);

insert into stocks (product_id, quantity, created_at, updated_at)
select id, 40, timestamp '2026-06-06 00:00:00', timestamp '2026-06-06 00:00:00'
from products
where id = 10004
  and not exists (select 1 from stocks where product_id = 10004);

insert into stocks (product_id, quantity, created_at, updated_at)
select id, 150, timestamp '2026-06-06 00:00:00', timestamp '2026-06-06 00:00:00'
from products
where id = 10005
  and not exists (select 1 from stocks where product_id = 10005);
...
from products
where id = 10001
  and not exists (select 1 from product_discounts where product_id = 10001);
...
from products
where id = 10004
  and not exists (select 1 from product_discounts where product_id = 10004);
...
select
    ...
    timestamp '2026-06-06 00:00:00',
    timestamp '2026-06-06 00:00:00'
where exists (select 1 from products where id = 10001)
...
select
    ...
    timestamp '2026-06-06 00:00:00',
    timestamp '2026-06-06 00:00:00'
where exists (select 1 from products where id = 10004)
